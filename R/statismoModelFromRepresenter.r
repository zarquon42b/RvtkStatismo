...
#' }
#' @export
statismoModelFromRepresenter <- function(representer,kernel=GaussianKernel(100,50),ncomp=10,nystroem=500) {
    ...
    out <- statismoGPmodel(pp,kernel=kernel,ncomp=ncomp,nystroem=nystroem)
    return(out)
}
